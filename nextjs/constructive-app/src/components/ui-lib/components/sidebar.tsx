...
function SidebarProvider({
	...
	// Effective open state: hover expands the sidebar on desktop
	// On desktop, hover takes precedence; on mobile, use openMobile
	const effectiveOpen = isMobile ? open : isHovered || open;
		...
		>
			...
			>
				<div
					...
					className='bg-sidebar group-data-[variant=floating]:border-sidebar-border/60 flex h-full w-full flex-col
	...
	return (
		<Comp
			...
			className={cn(
				...
				outline-hidden transition-[margin,opacity] duration-300 ease-in-out focus-visible:ring-2 [&>svg]:size-4
				[&>svg]:shrink-0`,
	...
	return (
		<Comp
			...
			className={cn(
				...
				top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden
...
const sidebarMenuButtonVariants = cva(
	'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding,margin,gap] duration-200 ease-[cubic-bezier(0.25,1,0.5,1)] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:h-8! group-data-[collapsible=icon]:w-9! group-data-[collapsible=icon]:mx-auto group-data-[collapsible=icon]:gap-0 group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
	{
		variants: {
			variant: {
