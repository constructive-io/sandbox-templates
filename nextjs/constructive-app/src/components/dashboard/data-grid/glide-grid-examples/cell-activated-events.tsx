	...
	return (
		<BeautifulWrapper
			...
			description={
				<>
					<Description>
						When you tap <KeyName>Enter</KeyName>, <KeyName>Space</KeyName>, start typing, or double click a cell, that
						cell is activated. You can track this with <PropName>onCellActivated</PropName>.
					</Description>
					<MoreInfo>
						Last activated cell: {lastActivated === undefined ? 'none' : `(${lastActivated[0]}, ${lastActivated[1]})`}
					</MoreInfo>
				</>
			}
		>
