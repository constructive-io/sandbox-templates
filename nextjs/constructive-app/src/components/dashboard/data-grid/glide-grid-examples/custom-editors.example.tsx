		...
		(Story: React.ComponentType) => (
			<SimpleThemeWrapper>
				<BeautifulWrapper
					...
					description={
						<Description>
							The <PropName>provideEditor</PropName> callback allows you to provide a custom editor for a cell. In this
							example, cells in the first column get a custom editor.
						</Description>
					}
				>
					<Story />
