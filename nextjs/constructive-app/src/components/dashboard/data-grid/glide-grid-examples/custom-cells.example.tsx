...
import { DataEditor, GridCellKind, type DataEditorProps } from '@glideapps/glide-data-grid';
...
import { allCells, DropdownCell as DropdownRenderer, MultiSelectCell as MultiSelectRenderer } from './index.js';
...
export const CustomCellEditing: React.VFC = () => {
	...
	return (
		<BeautifulWrapper
			...
			description={
				<Description>Cells can be edited and responding to copy/paste using the copyData attribute.</Description>
			}
		>
			<DataEditor
				{...defaultProps}
