...
export function useSendOrgInvite(defaultContext: SchemaContext = 'admin') {
...
export function useCancelOrgInvite(defaultContext: SchemaContext = 'admin') {
	void defaultContext;
	const queryClient = useQueryClient();
...
export function useExtendOrgInvite(defaultContext: SchemaContext = 'admin') {
	void defaultContext;
	const queryClient = useQueryClient();
