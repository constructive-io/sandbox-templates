-- Deploy: schemas/myapp_profiles_private/trigger_fns/app_profile_permissions_recompute_tg
...
CREATE FUNCTION myapp_profiles_private.app_profile_permissions_recompute_tg() RETURNS TRIGGER AS $_PGFN_$
DECLARE
  v_profile_id uuid;
