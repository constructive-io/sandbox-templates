...
CREATE INDEX org_memberships_sprts_actor_id_idx ON myapp_memberships_private.org_memberships_sprt USING BTREE ( actor_id ) INCLUDE ( permissions, is_owner, is_admin, is_read_only );
