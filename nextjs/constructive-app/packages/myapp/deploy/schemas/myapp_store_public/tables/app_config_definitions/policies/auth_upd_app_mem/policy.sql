-- Deploy: schemas/myapp_store_public/tables/app_config_definitions/policies/auth_upd_app_mem/policy
...
CREATE POLICY auth_upd_app_mem ON myapp_store_public.app_config_definitions
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
