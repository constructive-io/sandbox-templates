-- Deploy: schemas/myapp_invites_public/tables/app_invites/triggers/app_invites_profile_check_tg
-- made with <3 @ constructive.io

-- requires: schemas/myapp_invites_public/schema
-- requires: schemas/myapp_invites_private/schema
-- requires: schemas/myapp_invites_public/tables/app_invites/table
-- requires: schemas/myapp_invites_private/trigger_fns/app_invites_profile_check_tg
