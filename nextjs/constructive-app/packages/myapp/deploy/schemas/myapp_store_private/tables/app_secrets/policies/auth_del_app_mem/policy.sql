-- Deploy: schemas/myapp_store_private/tables/app_secrets/policies/auth_del_app_mem/policy
...
CREATE POLICY auth_del_app_mem ON myapp_store_private.app_secrets
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
