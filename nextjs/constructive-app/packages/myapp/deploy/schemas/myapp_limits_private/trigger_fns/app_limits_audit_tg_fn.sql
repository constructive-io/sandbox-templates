-- Deploy: schemas/myapp_limits_private/trigger_fns/app_limits_audit_tg_fn
...
CREATE FUNCTION myapp_limits_private.app_limits_audit_tg_fn() RETURNS TRIGGER AS $_PGFN_$
BEGIN
