-- Deploy: schemas/myapp_limits_private/trigger_fns/org_limits_upd_tg
-- made with <3 @ constructive.io

-- requires: schemas/myapp_limits_private/schema
-- requires: schemas/myapp_limits_private/procedures/org_limits_dec/procedure
-- requires: schemas/myapp_limits_private/procedures/org_limits_inc/procedure


CREATE FUNCTION myapp_limits_private.org_limits_upd_tg() RETURNS TRIGGER AS $_PGFN_$
DECLARE
  limit_ok boolean;
  old_actor_id uuid;
  new_actor_id uuid;
