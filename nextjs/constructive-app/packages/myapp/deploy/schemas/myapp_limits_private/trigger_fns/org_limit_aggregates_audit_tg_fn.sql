-- Deploy: schemas/myapp_limits_private/trigger_fns/org_limit_aggregates_audit_tg_fn
...
CREATE FUNCTION myapp_limits_private.org_limit_aggregates_audit_tg_fn() RETURNS TRIGGER AS $_PGFN_$
BEGIN
