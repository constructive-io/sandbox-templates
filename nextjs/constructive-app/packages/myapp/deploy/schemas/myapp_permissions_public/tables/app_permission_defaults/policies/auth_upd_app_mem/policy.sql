-- Deploy: schemas/myapp_permissions_public/tables/app_permission_defaults/policies/auth_upd_app_mem/policy
...
CREATE POLICY auth_upd_app_mem ON myapp_permissions_public.app_permission_defaults
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
