-- Deploy: schemas/myapp_permissions_public/tables/org_permission_defaults/policies/auth_upd_ent_mem/policy
...
CREATE POLICY auth_upd_ent_mem ON myapp_permissions_public.org_permission_defaults
FOR UPDATE
TO authenticated
USING (
