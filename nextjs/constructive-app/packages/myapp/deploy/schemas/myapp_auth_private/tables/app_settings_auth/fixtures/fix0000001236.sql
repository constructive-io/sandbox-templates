-- Deploy: schemas/myapp_auth_private/tables/app_settings_auth/fixtures/fix0000001236
...
VALUES
  ('f'::boolean, '2 weeks'::interval, '30 days'::interval, '1 hour'::interval, 'lax', 't'::boolean, 't'::boolean, 8, 'f'::boolean, '30 minutes'::interval, '5 minutes'::interval, 't'::boolean, 't'::boolean, 'f'::boolean, 'f'::boolean, 'f'::boolean, 't'::boolean, 'f'::boolean, 'f'::boolean, 'f'::boolean, 'f'::boolean, 'f'::boolean, 'f'::boolean, 'f'::boolean, 't'::boolean, 'f'::boolean, 't'::boolean, 't'::boolean, 'f'::boolean, 't'::boolean, 't'::boolean, 10, '90 days'::interval, '365 days'::interval, 10, '10 minutes'::interval, 't'::boolean, '/auth/error', 't'::boolean, 'lax', 't'::boolean, '2 weeks'::interval, '/', 'f'::boolean);
