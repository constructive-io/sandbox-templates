-- Deploy: schemas/myapp_events_public/tables/org_events/indexes/org_events_actor_id_name_entity_id_idx
...
CREATE INDEX org_events_actor_id_name_entity_id_idx ON myapp_events_public.org_events USING BTREE ( actor_id, name, entity_id );
