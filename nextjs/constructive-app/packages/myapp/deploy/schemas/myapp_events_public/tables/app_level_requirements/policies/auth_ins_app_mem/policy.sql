-- Deploy: schemas/myapp_events_public/tables/app_level_requirements/policies/auth_ins_app_mem/policy
...
CREATE POLICY auth_ins_app_mem ON myapp_events_public.app_level_requirements
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
