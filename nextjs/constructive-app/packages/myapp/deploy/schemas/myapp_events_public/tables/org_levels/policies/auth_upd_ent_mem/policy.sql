-- Deploy: schemas/myapp_events_public/tables/org_levels/policies/auth_upd_ent_mem/policy
-- made with <3 @ constructive.io

-- requires: schemas/myapp_events_public/schema
-- requires: schemas/myapp_events_public/tables/org_levels/table
-- requires: schemas/myapp_events_public/tables/org_levels/policies/enable_row_level_security


CREATE POLICY auth_upd_ent_mem ON myapp_events_public.org_levels
FOR UPDATE
TO authenticated
USING (
