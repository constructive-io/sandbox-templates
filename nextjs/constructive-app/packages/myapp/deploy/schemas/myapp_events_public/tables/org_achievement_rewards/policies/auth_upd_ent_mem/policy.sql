-- Deploy: schemas/myapp_events_public/tables/org_achievement_rewards/policies/auth_upd_ent_mem/policy
...
CREATE POLICY auth_upd_ent_mem ON myapp_events_public.org_achievement_rewards
FOR UPDATE
TO authenticated
USING (
