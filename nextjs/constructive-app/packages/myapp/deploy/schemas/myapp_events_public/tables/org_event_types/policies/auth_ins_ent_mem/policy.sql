-- Deploy: schemas/myapp_events_public/tables/org_event_types/policies/auth_ins_ent_mem/policy
...
CREATE POLICY auth_ins_ent_mem ON myapp_events_public.org_event_types
FOR INSERT
TO authenticated
WITH CHECK (
