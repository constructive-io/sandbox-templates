-- Deploy: schemas/myapp_events_public/tables/org_event_types/policies/auth_del_ent_mem/policy
-- made with <3 @ constructive.io

-- requires: schemas/myapp_events_public/schema
-- requires: schemas/myapp_events_public/tables/org_event_types/table
-- requires: schemas/myapp_events_public/tables/org_event_types/policies/enable_row_level_security


CREATE POLICY auth_del_ent_mem ON myapp_events_public.org_event_types
FOR DELETE
TO authenticated
USING (
