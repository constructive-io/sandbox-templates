-- Deploy: schemas/myapp_events_public/tables/app_levels/policies/auth_upd_app_mem/policy
-- made with <3 @ constructive.io

-- requires: schemas/myapp_events_public/schema
-- requires: schemas/myapp_events_public/tables/app_levels/table
-- requires: schemas/myapp_events_public/tables/app_levels/policies/enable_row_level_security


CREATE POLICY auth_upd_app_mem ON myapp_events_public.app_levels
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
