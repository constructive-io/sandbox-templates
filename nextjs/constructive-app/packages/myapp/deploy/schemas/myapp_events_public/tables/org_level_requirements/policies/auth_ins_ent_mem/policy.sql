-- Deploy: schemas/myapp_events_public/tables/org_level_requirements/policies/auth_ins_ent_mem/policy
...
CREATE POLICY auth_ins_ent_mem ON myapp_events_public.org_level_requirements
FOR INSERT
TO authenticated
WITH CHECK (
