-- Deploy: schemas/myapp_events_public/tables/app_achievement_rewards/policies/auth_del_app_mem/policy
...
CREATE POLICY auth_del_app_mem ON myapp_events_public.app_achievement_rewards
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
