-- Deploy: schemas/myapp_events_public/tables/app_event_types/policies/auth_upd_app_mem/policy
...
CREATE POLICY auth_upd_app_mem ON myapp_events_public.app_event_types
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
