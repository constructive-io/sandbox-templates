-- Deploy: schemas/myapp_events_public/tables/org_event_types/policies/auth_upd_ent_mem/policy
...
CREATE POLICY auth_upd_ent_mem ON myapp_events_public.org_event_types
FOR UPDATE
TO authenticated
USING (
