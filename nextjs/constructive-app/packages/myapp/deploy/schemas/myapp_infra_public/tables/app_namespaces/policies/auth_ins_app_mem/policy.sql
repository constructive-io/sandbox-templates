-- Deploy: schemas/myapp_infra_public/tables/app_namespaces/policies/auth_ins_app_mem/policy
...
CREATE POLICY auth_ins_app_mem ON myapp_infra_public.app_namespaces
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
