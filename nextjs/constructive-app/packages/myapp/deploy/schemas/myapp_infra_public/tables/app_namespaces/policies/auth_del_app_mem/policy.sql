-- Deploy: schemas/myapp_infra_public/tables/app_namespaces/policies/auth_del_app_mem/policy
...
CREATE POLICY auth_del_app_mem ON myapp_infra_public.app_namespaces
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
