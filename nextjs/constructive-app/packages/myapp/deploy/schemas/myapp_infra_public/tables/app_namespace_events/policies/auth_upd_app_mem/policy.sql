-- Deploy: schemas/myapp_infra_public/tables/app_namespace_events/policies/auth_upd_app_mem/policy
...
CREATE POLICY auth_upd_app_mem ON myapp_infra_public.app_namespace_events
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
